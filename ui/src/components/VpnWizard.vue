      ...
      <div v-if="currentStep.id === 'nordvpn-windows'" class="wizard-step">
        ...
        <div class="step-content">
          <slot name="nordvpn-content">
            <div class="info-box">
              ...
              <ol class="no-top-margin">
                ...
                <ul>
                  <li>Stay invisible on LAN = Off</li>
                </ul>
                <li>Under Settings / Killswitch:</li>
                <ul>
                  <li>Internet Kill Switch = Off</li>
                </ul>
                <li>Under Settings / Split tunnelling:</li>
                <ul>
                  <li>Split tunnelling = On</li>
                </ul>
                <ul>
                  <li>Add apps / Browse apps:</li>
                  <ul>
                    <!-- TODO: Vlad - get actual binary paths from daemon, instead of hardcoding -->
                    <li class="monospace-text">
                      c:\Program Files\privateLINE
                      Connect\privateline-connect-svc.exe
                    </li>
                    <li class="monospace-text">
                      c:\Program Files\privateLINE
                      Connect\ui\privateline-connect-ui.exe
                    </li>
                    <li class="monospace-text">
                      c:\Program Files\privateLINE
                      Connect\WireGuard\x86_64\wg.exe
                    </li>
                    <li class="monospace-text">
                      c:\Program Files\privateLINE
                      Connect\WireGuard\x86_64\wireguard.exe
                    </li>
                  </ul>
                </ul>
              </ol>
          ...
          <p class="warning-text">
            ⚠️ It is necessary to configure NordVPN this way to ensure
            privateLINE connectivity.
          </p>
        </div>
      </div>
        ...
        <slot name="final-instructions-content">
          ...
          <div class="step-content">
            ...
            <div class="info-box success">
              ...
              <p>
                You should now be able to use privateLINE without conflicts.
                Here are some tips:
              </p>
              <ul>
                <li>Check your connection status in the main application</li>
                <li>
                  If you need to use other VPNs, disable Total Shield in
                  privateLINE first
                </li>
