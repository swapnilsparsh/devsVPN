...
DESKTOP_SRC_FILE=/usr/share/applications/privateline-ui.desktop
ICON_SRC_FILE=/usr/share/icons/hicolor/scalable/apps/privateline.svg
...
#DESKTOP_APPS_FILE=$APPS_DIR/privateline-ui.desktop
#if [ -d "$APPS_DIR" ]; then
...
sudo chmod 4755 /opt/privateline/ui/bin/chrome-sandbox || echo "[!] Failed to 'chmod' for '/opt/privateline/ui/bin/chrome-sandbox'"
