...
set CERT_SHA1=%1
:: Set the folder path
set "path_windows_update_folder=C:\Program Files\IVPN Client"
...
:copy_files
	...
	echo     Renaming UI binary to 'privateLINE Client.exe' ...
	rename  "%INSTALLER_TMP_DIR%\ui\IVPN.exe" "privateLINE Client.exe" || goto :error
