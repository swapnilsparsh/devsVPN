...
func showState() error {
	...
	if !stStatus.IsFunctionalityNotAvailable {
		printSplitTunState(w, true, false, stStatus.IsSplitTunnelEnabled, stStatus.IsInversed, stStatus.IsAnyDns, stStatus.IsAllowWhenNoVpn, stStatus.SplitTunnelApps, stStatus.RunningApps)
	}
